...
import ObjetosU.AlumnoPostGrado;
import java.text.SimpleDateFormat;
import java.util.Date;
import javax.swing.JOptionPane;

public class JFAgrePosgrado extends javax.swing.JFrame {

    public JFAgrePosgrado() {
        initComponents();
        this.setTitle("Nuevo alumno de post grado");
    ...
    private void initComponents() {
        ...
        jLabel10.setText("AGREGAR ALUMNO POS GRADO");
        ...
        jtfnom.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Documento:");

        jtfdoc.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Dirección:");

        jtfdir.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jtfreg.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("Carerra de post grado:");

        jtfcarpg.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jtfreg, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jdcing, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jcbcar, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)
                            .addComponent(jcbfac, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jdcnac, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jtfdir, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButtonACEPTARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonACEPTARActionPerformed
        EntradaSalidaPosGrado input = new EntradaSalidaPosGrado(jtfdoc, jcbcar, jcbfac, jdcing, jdcnac, jtfdir, jtfnom, jtfreg, jtfcarpg); 
        AlumnoPostGrado apg = new AlumnoPostGrado(); 
        input.ingresarPosGrado(apg);
        if(apg.campoVacio())
            JOptionPane.showMessageDialog(null, "Error: debe ingresar todos los campos");
        else if (JFMenuPrin.enLista(apg.getDoc()))
            JOptionPane.showMessageDialog(null, "Error: la persona con dni " + apg.getDoc() + " ya se encuentra en el sistema");
        else
        {
            JFMenuPrin.agregarFilaATabla(new Object[]{"Posgrado", apg.getDoc(), apg.getNbre(), apg.getDir()});                                         
            JFMenuPrin.agregarPersonaALista(apg);
            dispose();
        }   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFAgrePosgrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFAgrePosgrado().setVisible(true);
            }
        });
    }
