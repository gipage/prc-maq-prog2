...
import EntradaSalida.EntradaSalidaDocente;
...
public class JFAgreDocente extends javax.swing.JFrame {

    /**
     * Creates new form JFrameAgregarDocente
     */
    public JFAgreDocente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("AGREGAR DOCENTE");
        ...
        jButtonIngresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/save.png"))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jcbcargo, 0, 300, Short.MAX_VALUE))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(14, 14, 14)
    ...
    private void jButtonIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIngresarActionPerformed
       EntradaSalidaDocente input = new EntradaSalidaDocente(jtfdoc, jcbcar, jcbfac, jdcing, jdcnac, 
                                                                    jtfdir, jtfnom, jcbcargo, jtmaterias); 
        Docente docente = new Docente(); 
        input.ingresarDocente(docente);
        if(docente.campoVacio())
            JOptionPane.showMessageDialog(null, "Error: debe ingresar todos los campos y al menos una materia");
        else if (JFMenuPrin.enLista(docente.getDoc()))
            JOptionPane.showMessageDialog(null, "Error: la persona con dni " + docente.getDoc() + " ya se encuentra en el sistema");
        else
        {
            JFMenuPrin.agregarFilaATabla(new Object[]{"Docente", docente.getDoc(), docente.getNbre(), docente.getDir()});                                         
            JFMenuPrin.agregarPersonaALista(docente);
            dispose();
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFAgreDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFAgreDocente().setVisible(true);
            }
        });
    }
